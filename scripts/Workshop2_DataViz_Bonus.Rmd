...
path_data <- "C:/Users/cmcinnerney/OneDrive - DOI/Desktop/Workshop2_DataVisualization/data/"
path_output <- "C:/Users/cmcinnerney/OneDrive - DOI/Desktop/Workshop2_DataVisualization/output/"
```
...
```{r}
ggsave(path=path_output, filename = "BITH - Woody Veg Density (Line Graph).jpg", width = 8, height = 6, unit = "in", dpi = 300)
```
